...
class FuncionarioQuadroHorarioController extends BaseController
{
    ...
    */
    ...
    /**
     * @OA\Post(
     *     path="/funcionario/quadro-horario",
     ...
     *         required=true,
     *         @OA\JsonContent(
     *             required={"id_funcionario", "escala", "tipo"},
     *             @OA\Property(property="id_funcionario", type="integer", description="ID do funcionário", example=1),
     *             @OA\Property(property="escala", type="integer", description="ID da escala", example=2),
     *             @OA\Property(property="tipo", type="integer", description="ID do tipo de quadro horário", example=3),
    ...
    */
    public function create(Request $request) : JsonResponse
    {
        try {
            ...
            $remuneracaoTipo = $this->funcionarioService->cadastrarQuadroHorario($request->all());
